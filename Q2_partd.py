...
def simulate(init_position = np.array([10, 10]), init_velocity= np.random.rand(2) * 5, delta_time= 0.1,
...
delta_time= 0.1
positions, measurements = simulate(init_position = np.array([10, 10]), init_velocity= np.random.rand(2) * 5, delta_time= 0.1,
             Rt =  np.diag([1.0, 1.0, 0.01, 0.01]), Qt = np.eye(2) * 100, T_step = 200)
