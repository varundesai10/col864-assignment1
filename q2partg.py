...
delta_time= 1
positions, measurements = simulate(init_position = initial_position, init_velocity= initial_velocity, delta_time= 1, control= 1, Rt =  np.diag([1.0, 1.0, 0.01, 0.01]), Qt = np.eye(2) * 100, T_step = 200)
